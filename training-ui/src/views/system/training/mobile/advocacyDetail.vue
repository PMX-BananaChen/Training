<template>
  <div id="bodyId">
    ...
    <div class="typo typo-selection" v-html="this.content"></div>
    <div style="height:15vh;background: white;"></div>

    <van-tabbar v-model="active">
      <van-tabbar-item icon="revoke" @click="onClickLeft">返回</van-tabbar-item>
    </van-tabbar>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      title: '政策宣导 — ' + this.$route.params.list.title,
      active: '',
      // likeCount: 0,
      reading: 0,
