<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="资讯发布年份" prop="year">
        <el-select
          v-model="queryParams.year"
          placeholder="请选择资讯发布年份"
          clearable
          size="small"
        >
          <el-option
            v-for="dict in dict.type.sys_share_year"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <dict-tag
            :options="dict.type.sys_share_year"
...
import {
  ...
  updateShare,
  topShare
} from "@/api/system/training/share";
import PickingRichTextUpload from "../share/PickingRichTextUpload";
...
export default {
  ...
  methods: {
    ...
    handleAdd1() {
      this.reset();
      this.open1 = true;
      this.uploadData1 = { page: "edit",data:"share"};
      this.title = "培训介绍简介设置";
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
