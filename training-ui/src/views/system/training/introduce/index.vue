  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="介绍类型" prop="type">
        ...
        >
        <el-option
            v-for="dict in dict.type.sys_introduce_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:introduce:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="2.5">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <dict-tag
            :options="dict.type.sys_introduce_type"
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['system:introduce:edit']"
            >修改</el-button
          >
          <el-button
            size="mini"
...
import {
  ...
  updateIntroduce,
  topIntroduce
} from "@/api/system/training/introduce";
import PickingRichTextUpload from "../introduce/PickingRichTextUpload";
...
export default {
  ...
  created() {
    this.getList();
    this.getDicts("sys_introduce_type").then((response) => {
  ...
  methods: {
    ...
    getList() {
      ...
      this.queryParams.endTime = this.sertchTime.createTime
        ...
        : null;
      listIntroduce(this.queryParams).then((response) => {
    ...
    handleAdd1() {
      this.reset();
      this.open1 = true;
      this.uploadData1 = { page: "edit",data:"introduce"};
      this.title = "培训介绍简介设置";
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
      ...
      this.$refs["form"].validate((valid) => {
        if (valid) {
          if (this.form.id != null) {
            updateIntroduce(this.form).then((response) => {
            ...
            addIntroduce(this.form).then((response) => {
              if (response.code === 200) {
