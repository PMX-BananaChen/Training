  ...
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="文章类型" prop="type">
        ...
        >
          <el-option
            v-for="dict in dict.type.sys_periodical_type"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:periodical:add']"
          >上传</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:periodical:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="2.5">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <dict-tag
            :options="dict.type.sys_periodical_type"
      ...
      >
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['system:periodical:edit']"
            >修改</el-button
          >
          <el-button
            size="mini"
...
import {
  ...
  updatePeriodical,
  topPeriodical
} from "@/api/system/training/periodical";
import PickingRichTextUpload from "../periodical/PickingRichTextUpload";
...
export default {
  ...
  methods: {
    ...
    handleAdd1() {
      this.reset();
      this.open1 = true;
      this.uploadData1 = { page: "edit",data:"periodical"};
      this.title = "培训介绍简介设置";
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
